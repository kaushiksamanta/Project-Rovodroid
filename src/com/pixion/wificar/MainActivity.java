	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		b1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
		    	...
		    	else if((wm.getWifiState() == WifiManager.WIFI_STATE_ENABLED) && (mWifi.isConnected()))
		    	{
		    		Toast.makeText(getApplicationContext(), "Wifi Connection Established", Toast.LENGTH_LONG).show();
		    		Intent ac = new Intent("com.pixion.wificar.ActivityCar");
		    		startActivity(ac);
		    	}
		    	else
		    	{
		    		Toast.makeText(getApplicationContext(), "Waiting for WiFi to connect", Toast.LENGTH_LONG).show();
		    	}
			}
		});
